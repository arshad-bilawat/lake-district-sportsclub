(function () {
    'use strict';
    var salesbyAmount = angular.module('salesbyAmount', ['ui.router', 'services'])
    salesbyAmount.controller('salesbyAmountController', function ($scope, $rootScope, $stateParams, $q, salesService) {
            ...
            $scope.products.forEach(function (element) {
                if (result[element.id]) {
                    $scope.productList.push({
                        ...
                        totalsale: element.price * result[element.id].quantity
                    })
                }
            }, this);
        }
